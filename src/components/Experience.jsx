  ...
  const experiences = [
    {
      id: 1,
      company: "Werq Labs",
      position: "Hybrid Developer",
      duration: "2024 - Present",
      description:
        "Designed and delivered cross-platform mobile apps using Flutter alongside scalable web applications in React, backed by Node.js APIs. Focused on performance, clean architecture, and cloud deployment while collaborating closely with product teams.",
      technologies: [
        "Flutter",
        "Node.js",
        "React",
    ...
    },
    {
      ...
      duration: "2023 - 2024",
      description:
        "Built full-stack applications with React, Flutter, and Node.js, integrating REST APIs and MongoDB for efficient data handling. Worked on responsive UI development, backend logic, and cloud hosting to deliver reliable production systems.",
      technologies: ["Flutter", "Node.js", "React", "MongoDB", "AWS"],
    },
  ];
